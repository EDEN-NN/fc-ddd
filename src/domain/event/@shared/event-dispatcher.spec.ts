...
import CustomerCreatedHandler from "../customer/handler/customer-created-event.handler";
import CustomerUpdatedHandler from "../customer/handler/customer-updated-event.handler";
...
describe("Domain events tests", () => {
    ...
    it("should unregister an event handler", () => {
      ...
      it("Should notify when a customer is created", () => {
        ...
        const eventHandler2 = new CustomerUpdatedHandler();
        const spyEventHandler = jest.spyOn(eventHandler, "handle");
        ...
        const customerCreatedEvent = new CustomerCreated({
            name: "Gadelho",
